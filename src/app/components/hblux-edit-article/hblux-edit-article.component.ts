...
@Component({
  selector: 'app-hblux-edit-article',
  templateUrl: './hblux-edit-article.component.html',
  styleUrls: ['./hblux-edit-article.component.css']
})
export class HbluxEditArticleComponent implements OnInit {


  reussi=""
  reactiveArticle:FormGroup=this.fb.group({})
  constructor(private activatedRoute:ActivatedRoute,private fb:FormBuilder, private articleService:HbluxArticleService) { }
  article:Article={
  ...
  onInitReactiveForm(){
    this.reactiveArticle=this.fb.group({
      ...
      photo3:[this.article.photos[0],[Validators
        .required]],
